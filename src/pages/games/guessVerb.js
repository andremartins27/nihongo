...
export default function GuessVerb() {
  /**
   * @param {Form} question
   * @param {String} guess
   */
  function verifyGuess(question, guess) {
    ...
    return isMatch(question.japanese, guess) || isMatch(question.romanji, guess);
  }
  ...
  return (
    <>
        ...
        <p>Write in hiragana or romanji the verb that matches the discription</p>
        <p>Use dictionary form</p>
      </div>
      </div>
      <div>
        <GuessingGame
